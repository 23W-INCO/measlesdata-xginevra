...
# Sample data
with open("merged_data_fhir.json") as json_data:
...
for resource in measle_data:
    ...
    componets_list = [
        {"code": {"coding": [{"system": "http://loinc.org", "code": "8629-0"}], "text": "Measles Cases"},
         "valueQuantity": Quantity(value=entry["cases"], unit="cases", system="http://unitsofmeasure.org", code="{cases}")
         },

        {"code": {"coding": [{"system": "http://loinc.org", "code": "totalPopulation"}], "text": "Population"},
         "valueQuantity": Quantity(value=float(entry["totalPopulation"].replace(".", "")), unit="individuals", system="http://unitsofmeasure.org", code="{individuals}")
         }
    ]
    if "vaccinationRate" in entry:
        new = {"code": {"coding": [{"system": "http://loinc.org", "code": "VaccinationRate"}], "text": "Vaccination Rate"},
               "valueQuantity": Quantity(value=entry["vaccinationRate"], unit="%", system="http://unitsofmeasure.org", code="{percent}")
               }
        componets_list.append(new)
    if "casesPer100000" in entry:
        new = {"code": {"coding": [{"system": "http://loinc.org", "code": "Per100000"}], "text": "Per 100,000"},
               "valueQuantity": Quantity(value=entry["casesPer100000"], unit="1/100000", system="http://unitsofmeasure.org", code="{1/100000}")
               }
        componets_list.append(new)
